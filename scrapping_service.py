    ...
    def scrape_all_laptops(self, product_name):
        ...
        for link in all_pages_links:
            ...
            try:
                ...
                price = "0"
                logging.warning("The price of this product is not available")
            try:
            ...
            try:
                hdd = [i.text for s in ['button.btn.swatch', 'button.btn.primary'] for i in scrapped_page.select(s)]
            except:
                hdd=[]
                logging.warning("The hdd's of this product are not available")
